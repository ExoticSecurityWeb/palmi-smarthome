...
// === Fonctions de contrôle de la lumière ===
...
// === ROUTE HTTP MODE BLANC ===

app.get("/light/white", async (req, res) => {
  try {
    const warmth = parseInt(
      req.query.warmth ?? "50",
      10
    );
